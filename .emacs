...
(custom-set-faces
 ...
 '(font-lock-builtin-face ((((class color) (min-colors 88) (background dark)) (:foreground "blue violet"))))
 '(font-lock-comment-face ((((class color) (min-colors 88) (background dark)) (:foreground "dim gray"))))
 '(font-lock-keyword-face ((((class color) (min-colors 88) (background dark)) (:foreground "Red3"))))
